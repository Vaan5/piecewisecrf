...
def neg_log_likelihood(out_unary, out_binary, labels_unary, labels_binary, batch_size, weights, weight_surr):
    '''
    ...
    with tf.op_scope([out_unary, out_binary, labels_unary, labels_binary], None, 'NegativeLogLikelyhood'):
        ...
        pb = tf.mul(tf.minimum(tf.to_float(100), weight_surr), xent_bin)
