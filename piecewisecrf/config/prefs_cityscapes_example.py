...
tf.app.flags.DEFINE_string('train_dir', '/home/dcausevic/Desktop/final_results/results_unary_surr_5x5_bn',
                           'Directory where to write event logs and checkpoint.')

# Records directories
tf.app.flags.DEFINE_string('train_records_dir',
                           '/home/dcausevic/datasets/cityscapes_full_prepared_5x5/train_train/608x304/tfrecords/',
                           'Path to the directory containing training tfrecords')
tf.app.flags.DEFINE_string('val_records_dir',
                           '/home/dcausevic/datasets/cityscapes_full_prepared_5x5/train_val/608x304/tfrecords/',
                           'Path to the directory containing training tfrecords')
tf.app.flags.DEFINE_string('test_records_dir',
                           '/home/dcausevic/datasets/cityscapes_full_prepared_5x5/val/608x304/tfrecords/',
                           'Path to the directory containing training tfrecords')
