...
tf.app.flags.DEFINE_string('train_dir', '/home/dcausevic/results_3x3_debug',
...
tf.app.flags.DEFINE_string('checkpoint_dir', '/home/dcausevic/results_3x3_debug', 'Path to the directory containing trained models')
