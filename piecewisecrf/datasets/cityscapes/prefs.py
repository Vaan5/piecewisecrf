...
flags.DEFINE_string('save_dir', '/home/dcausevic/datasets/cityscapes_full_prepared_5x5/',
...
tf.app.flags.DEFINE_string('train_dir', '/home/dcausevic/results_unary_surr_5x5_bn',
                           'Directory where to write event logs and checkpoint.')
tf.app.flags.DEFINE_integer('max_epochs', 30, 'Number of batches to run.')
tf.app.flags.DEFINE_string('train_records_dir', '/home/dcausevic/datasets/cityscapes_full_prepared_5x5/train_train/608x304/tfrecords/',
                           'Path to the directory containing training tfrecords')
tf.app.flags.DEFINE_string('val_records_dir', '/home/dcausevic/datasets/cityscapes_full_prepared_5x5/train_val/608x304/tfrecords/',
                           'Path to the directory containing training tfrecords')
tf.app.flags.DEFINE_string('test_records_dir', '/home/dcausevic/datasets/cityscapes_full_prepared_5x5/val/608x304/tfrecords/',
                           'Path to the directory containing training tfrecords')
...
tf.app.flags.DEFINE_string('checkpoint_dir', '/home/dcausevic/results_unary_surr_5x5_bn', 'Path to the directory containing trained models')
