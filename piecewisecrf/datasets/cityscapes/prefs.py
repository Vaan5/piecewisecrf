...
tf.app.flags.DEFINE_string('train_dir', '/home/dcausevic/results_3x3_fullBN',
                           'Directory where to write event logs and checkpoint.')
tf.app.flags.DEFINE_integer('max_epochs', 30, 'Number of batches to run.')
tf.app.flags.DEFINE_string('train_records_dir', '/home/dcausevic/datasets/cityscapes_full_prepared/train_val/608x304/tfrecords/',
...
tf.app.flags.DEFINE_string('checkpoint_dir', '/home/dcausevic/results_3x3_fullBN', 'Path to the directory containing trained models')
