...
flags.DEFINE_string('save_dir', '/home/dcausevic/datasets/cityscapes_rad_unary_ab_5x5_cb/',
...
tf.app.flags.DEFINE_string('train_dir', '/home/dcausevic/Desktop/rad_results/rad_unary_ab_5x5_cb',
                           'Directory where to write event logs and checkpoint.')
tf.app.flags.DEFINE_integer('max_epochs', 20, 'Number of batches to run.')
tf.app.flags.DEFINE_string('train_records_dir', '/home/dcausevic/datasets/cityscapes_rad_unary_ab_5x5_cb/train_train/608x304/tfrecords/',
                           'Path to the directory containing training tfrecords')
tf.app.flags.DEFINE_string('val_records_dir', '/home/dcausevic/datasets/cityscapes_rad_unary_ab_5x5_cb/train_val/608x304/tfrecords/',
                           'Path to the directory containing training tfrecords')
tf.app.flags.DEFINE_string('test_records_dir', '/home/dcausevic/datasets/cityscapes_rad_unary_ab_5x5_cb/val/608x304/tfrecords/',
                           'Path to the directory containing training tfrecords')
...
tf.app.flags.DEFINE_string('checkpoint_dir', 'home/dcausevic/Desktop/rad_results/rad_unary_ab_5x5_cb', 'Path to the directory containing trained models')
