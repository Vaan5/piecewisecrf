...
def loss(out_unary, out_binary, labels_unary, labels_binary, batch_size, weights, weights_surr, is_training=True):
    '''
    ...
    '''
    loss_val = losses.neg_log_likelihood(out_unary, out_binary, labels_unary, labels_binary, batch_size, weights, weights_surr)
    all_losses = [loss_val]
