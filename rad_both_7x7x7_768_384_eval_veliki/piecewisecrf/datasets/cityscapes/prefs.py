...
tf.app.flags.DEFINE_string('train_records_dir', '/home/dcausevic/datasets/cityscapes_rad_both_7x7x7_768_384_eval_veliki/train_train/768x384/tfrecords/',
                           'Path to the directory containing training tfrecords')
tf.app.flags.DEFINE_string('val_records_dir', '/home/dcausevic/datasets/cityscapes_rad_both_7x7x7_768_384_eval_veliki/train_val/768x384/tfrecords/',
                           'Path to the directory containing training tfrecords')
tf.app.flags.DEFINE_string('test_records_dir', '/home/dcausevic/datasets/cityscapes_rad_both_7x7x7_768_384_eval_veliki/val/768x384/tfrecords/',
                           'Path to the directory containing training tfrecords')
...
tf.app.flags.DEFINE_string('checkpoint_dir', '/home/dcausevic/Desktop/rad_results/rad_both_7x7x7_768_384_eval_veliki', 'Path to the directory containing trained models')
