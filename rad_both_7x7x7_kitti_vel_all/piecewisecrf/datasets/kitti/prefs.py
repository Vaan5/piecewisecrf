...
flags.DEFINE_integer('img_height', 192, 'Resized image height')
...
flags.DEFINE_integer('num_classes', 11,
...
tf.app.flags.DEFINE_string('train_records_dir', '/home/dcausevic/datasets/kitti_608x192_vel_all/train_train/608x192/tfrecords/',
                           'Path to the directory containing training tfrecords')
tf.app.flags.DEFINE_string('val_records_dir', '/home/dcausevic/datasets/kitti_608x192_vel_all/train_val/608x192/tfrecords/',
                           'Path to the directory containing training tfrecords')
tf.app.flags.DEFINE_string('test_records_dir', '/home/dcausevic/datasets/kitti_608x192_vel_all/valid/608x192/tfrecords/',
                           'Path to the directory containing training tfrecords')
...
tf.app.flags.DEFINE_string('checkpoint_dir', '/home/dcausevic/Desktop/rad_results/rad_kitti_608_192_vel_all', 'Path to the directory containing trained models')
